...
# EA Model - End
  ...
  while done == False:
      ...
      # From EA Model Start
      gCount=font.render("Ghosts: "+str(len(monsta_list)), True, red)
      screen.blit(gCount, [450, 10])
      # From EA Model End
      ...
      compare_time = pygame.time.get_ticks()

      print(monsta_list)
      print(i)
      print(compare_time)

      mon_list = [Clyde, Blinky, Pinky, Inky]

      if (compare_time / 30000) >= i:
